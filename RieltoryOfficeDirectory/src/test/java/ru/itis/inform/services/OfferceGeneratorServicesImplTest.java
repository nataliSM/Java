...
public class OfferceGeneratorServicesImplTest {
    ...
    public void setUp() throws Exception {
        ...
        when(offersDAO.getAllOffersWithParams(2,"хорошее","есть","Казань")).thenReturn(offers);
    ...
    public void generateOfferces() throws Exception {
        ...
        List<Offer> offers = offerseGeneratorService.generateOfferces(2,"хорошее","есть","Казань");
